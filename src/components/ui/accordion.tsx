...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        'border px-2 border-brand-black/10 hover:border-brand-black/50 data-[state=open]:border-brand-black',
        className,
      )}
      {...props}
    />
